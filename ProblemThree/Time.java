 ...
 * The class provides getter and setter methods to manipulate the time,
 * and methods to advance or rewind the time by one second.
 * The toString() method formats the time in hh:mm:ss format with leading zeros.
 */
